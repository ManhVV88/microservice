...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse<Object>> handleIdentityException(WalletException e) {
        ...
        ErrorCode errorCode = ErrorCode.INVALID_KEY;
         var constraintViolation = ex.getConstraintViolations().stream().findFirst()
                 .orElseThrow(() -> {
                     ...
                     return new WalletException(ErrorCode.UNCATEGORIZED_EXCEPTION);
                 });
    ...
    ResponseEntity<ApiResponse<Object>> handleStaleObjectStateException(StaleObjectStateException e) {
        ErrorCode errorCode = ErrorCode.ERROR_UPDATE_DETAIL;
        log.error("handleStaleObjectStateException : {}", e.getMessage());
        return ResponseEntity.status(errorCode.getStatusCode())
                .body(ApiResponse.builder()
                        .code(errorCode.getCode())
                        .message(errorCode.getMessage())
    ...
    private String mapAttribute(String message, Map<String, Object> attributes,String... fieldName) {
        ...
        if(attributes != null) {
            ...
            message = message.replace(STR."{\{MIN_ATTRIBUTE}}", minValue);
            message = message.replace(STR."{\{MAX_ATTRIBUTE}}", maxValue);
        }
